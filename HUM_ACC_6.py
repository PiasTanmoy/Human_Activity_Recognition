...
train = train[train[:,561].argsort()]
np.savetxt("train.csv", train, delimiter=",")

test = np.column_stack((X_test, y_test))
test = test[test[:,561].argsort()]
...
Train = pd.read_csv('Decomposed_Dataset/Train_6.csv')
Test = pd.read_csv('Decomposed_Dataset/Test_6.csv')
...
y_train = y_train.reshape(7413,1)
y_test = y_test.reshape(2994,1)
